  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-4 text-center bg-gradient-to-br from-gray-50 via-white to-white">
      <div className="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-6">
        <i className="ri-error-warning-line text-3xl text-primary" />
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          type="button"
          onClick={reset}
          className="px-8 py-3 rounded-full bg-primary text-white font-semibold hover:opacity-90 transition-colors"
        >
          Try again
        </button>
        <Link
          href="/shop"
          className="px-8 py-3 rounded-full border-2 border-primary text-primary font-semibold hover:bg-gray-50 transition-colors"
        >
          Go to Shop
        </Link>
      </div>
