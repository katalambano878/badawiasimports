  ...
  if (error || !order) {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center px-4 text-center">
        ...
        <Link href="/account?tab=orders" className="text-gray-900 font-semibold">
          Back to orders
        </Link>
      </main>
    );
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="border border-gray-200 rounded-xl p-8 print:border-0 print:p-0">
          <div className="flex items-start justify-between gap-4 mb-8">
            <div>
              <p className="text-2xl font-bold tracking-wide">BADAWIA&apos;S IMPORTS</p>
              <p className="text-sm text-gray-600">Quality imports across Ghana</p>
            </div>
